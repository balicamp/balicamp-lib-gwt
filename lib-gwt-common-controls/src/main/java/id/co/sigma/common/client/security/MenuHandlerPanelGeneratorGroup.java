			...
			if ( generators!= null ){
				 for ( @SuppressWarnings("rawtypes") IMenuHandlerPanelGenerator scn : generators ){
					 if (   data.getMenuCode().equals(  scn.getMenuCode())){
						 ...
						 GWT.log("OK hanlder untuk menu : " +  data.getMenuCode() + " ,di temukna pada class : " + MenuHandlerPanelGeneratorGroup.this.getClass().getName());
				...
				GWT.log("generator ini null(class:" +  MenuHandlerPanelGeneratorGroup.this.getClass().getName() +")");
			}
			
			GWT.log("untuk menu code : " + data.getMenuCode() + " tidak di temukan handler pada class : " +  MenuHandlerPanelGeneratorGroup.this.getClass().getName() );
