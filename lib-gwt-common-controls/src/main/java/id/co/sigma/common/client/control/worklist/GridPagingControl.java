...
public class GridPagingControl extends Widget implements BasePagingControl{
	...
	protected native void bindClickButtonHandler(Element element)/*-{
		...
		$wnd.$(element).click(function (){
				...
				var tag =  element.getAttribute(@id.co.sigma.common.client.control.worklist.GridPagingControl::TAG_PAGING_COMMAND);
				
				if (tag=="first")
					swapThis.@id.co.sigma.common.client.control.worklist.GridPagingControl::navigateFirst()();
				if (tag=="prev")
					swapThis.@id.co.sigma.common.client.control.worklist.GridPagingControl::navigatePrev()();
				if (tag=="next")
					swapThis.@id.co.sigma.common.client.control.worklist.GridPagingControl::navigatenext()();
				if (tag=="last")
					swapThis.@id.co.sigma.common.client.control.worklist.GridPagingControl::navigateLast()();			
	...
	protected native void sinkKeyPressHandler(Element element)/*-{
		...
		var mthd = function(e){
			if ( e.which==13||e.which==10)
				thisRef.@id.co.sigma.common.client.control.worklist.GridPagingControl::handleEnterPress()();
		}
