...
/**
 * Komponent yg menampilkan Label, titik dua dan Float Text Box area. Komponen ini harus di-wrapper dalam tag table<br>
 * <code> 		
 * 		< table ><br>
 * 			< tr ><br>
 * 				< td >< /td ><br>
 * 				< td >< /td><br>
 * 				< td >< p1:FloatTextBoxWithLabel ui:field="txtBoxTest2" /> < /td><br>
 * 			< tr ><br> 			
 * 		</ table>
 * </code>
 ...
 * @since 17 aug 2012
 */
public class FloatTextBoxWithLabel extends FloatTextBox implements AutomaticLabeledControl, BaseFormElement{
	 ...
	 * @param roundAfterDot
	 * @param numberOfRoundingAfterDot
	 */
	public FloatTextBoxWithLabel(boolean roundAfterDot, int numberOfRoundingAfterDot){
