...
/**
 * Komponent yg menampilkan Label, titik dua dan integer textbox area. Komponen ini harus di-wrapper dalam tag table<br>
 * <code> 		
 * 		< table ><br>
 * 			< tr ><br>
 * 				< td >< /td ><br>
 * 				< td >< /td><br>
 * 				< td >< p1:IntegerTextBoxWithLabel ui:field="txtBoxTest2" /> < /td><br>
 * 			< tr ><br> 			
 * 		</ table>
 * </code>
 ...
 * @since 17 aug 2012
 */
public class IntegerTextBoxWithLabel extends IntegerTextBox implements AutomaticLabeledControl{
	 ...
	 * Constructor Default
	 */
	public IntegerTextBoxWithLabel(){
		super();
	}
