package id.co.sigma.common.client.jqueryui;



import id.co.sigma.common.client.RawJsDate;
...
public abstract class BaseJqueryWidget extends Widget{
	...
	protected native void putConstructorArgument (String optionName  , Object argValue) /*-{
		this.@id.co.sigma.common.client.jqueryui.BaseJqueryWidget::widgetConstructArgument[optionName]=argValue;
	...
	//protected native int triggerIntegerReturnMethod (String controlId , String jqueryObjectName , String methodName)/*-{
	...
	//protected native void triggerSingleArgmentJQueryMethod (String controlId , String jqueryObjectName , String methodName , Object argument)/*-{
	...
	//protected native void triggerVoidMethod(String controlId , String jqueryObjectName , String methodName)/*-{
	...
	//protected native void triggerVoidMethod(String controlId , String jqueryObjectName ,String methodName , Object methodArgument)/*-{
	...
	//protected native void triggerVoidMethod(String controlId , String jqueryObjectName ,String methodName ,  Object methodArgument1, Object methodArgument2)/*-{
