...
import id.co.sigma.common.client.jqueryui.grid.BaseJQGridPanel;
import id.co.sigma.common.client.jqueryui.grid.CustomFormatter;
...
public abstract class BaseColumnDefinition<DATA , COLTYPE> implements ResourceBundleConfigurableControl{
	...
	/**
	 * reference balik column def ke grid. ini untuk perintah tertentu ke grid. misal untuk proses reload
	 */
	private BaseJQGridPanel<DATA> gridReference ; 
	/**
	...
	* <li>select (this is not a real select but a special case for editing modules. See note below)</li>
	...
	protected native JavaScriptObject buildNativeFormatterWrapper (CustomFormatter<DATA> actualFormatter) /*-{
		...
		var retval = function (el, cellval, opts) {
			var hashMap =  swapthis.@id.co.sigma.common.client.jqueryui.grid.cols.BaseColumnDefinition::indexedGridDataByRowId;
			var objPOJO =  hashMap.@java.util.HashMap::get(Ljava/lang/Object;)(cellval.rowId);
			return actualFormatter.@id.co.sigma.common.client.jqueryui.grid.CustomFormatter::format(Ljava/lang/Object;)(objPOJO);
		}
	 ...
	 * reference balik column def ke grid. ini untuk perintah tertentu ke grid. misal untuk proses reload
	 */
	public BaseJQGridPanel<DATA> getGridReference() {
	 ...
	 * reference balik column def ke grid. ini untuk perintah tertentu ke grid. misal untuk proses reload
	 */
	public void setGridReference(BaseJQGridPanel<DATA> gridReference) {
