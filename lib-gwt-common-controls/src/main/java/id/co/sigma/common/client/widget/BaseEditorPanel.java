...
import id.co.sigma.common.client.DataEditRequestCallback;
...
public abstract class BaseEditorPanel<DATA> extends BaseResourceBundleFriendlyComposite implements IEditorPanel<DATA>{
	...
	/**
	 * trigger. Ini di pergunakan untuk marking kalau proses edit sudah selesai. jadi caller bisa refresh data kalau di perlukan
	 */
	private  DataEditRequestCallback<DATA> afterEditOrViewCallback ;
	/**
	 ...
	 * trigger. Ini di pergunakan untuk marking kalau proses edit sudah selesai. jadi caller bisa refresh data kalau di perlukan
	 */
	public void setAfterEditOrViewCallback(
			DataEditRequestCallback<DATA> afterEditOrViewCallback) {
		this.afterEditOrViewCallback = afterEditOrViewCallback;
	}
	/**
	 * trigger. Ini di pergunakan untuk marking kalau proses edit sudah selesai. jadi caller bisa refresh data kalau di perlukan
	 */
