...
import id.co.sigma.common.client.jqueryui.enums.AnimationSpeed;
import id.co.sigma.common.client.jqueryui.enums.WeekName;
...
public class JQDatePicker extends BaseJqueryWidget implements HasText,HasValue<Date>, HasChangeHandlers,HasAllKeyHandlers , BaseFormElement{
	...
	protected com.google.gwt.user.client.Element generateUnderlyingElement() {
		...
		return (com.google.gwt.user.client.Element) retval;
	}
	...
	private native void renderDatePickerWorker(String widgetId, String jqueryClassname , JavaScriptObject datepickerArg) /*-{
		...
		datepickerArg["beforeShowDay"]= function(theDate){
				...
				var qa=thisReference.@id.co.sigma.common.client.jqueryui.form.JQDatePicker::isDateEnabled(III)(theYear,theMonth,day);
				return [qa,''];
			};
		
		$wnd.$(selector)[jqueryClassname](datepickerArg);
		this.@id.co.sigma.common.client.jqueryui.BaseJqueryWidget::jqueryRendered=true ;
