...
import id.co.sigma.common.client.form.ExtendedDatePicker;
import id.co.sigma.common.client.util.I18Utilities;

/**
 * Komponent yg menampilkan Label, titik dua dan date picker. Komponen ini harus di-wrapper dalam tag table<br>
 * <code> 		
 * 		< table ><br>
 * 			< tr ><br>
 * 				< td >< /td ><br>
 * 				< td >< /td><br>
 * 				< td >< p1:DatePickerWithLabel ui:field="txtBoxTest2" /> < /td><br>
 * 			< tr ><br> 			
 * 		</ table>
 * </code>
 ...
 * @since 17 aug 2012
 */
public class DatePickerWithLabel extends ExtendedDatePicker implements AutomaticLabeledControl{
